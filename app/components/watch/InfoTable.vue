<template>
  <v-row class="app-watch-info-table py-0">
    ...
    >
      <span
        v-if="data.ratingAgeLimits"
        class="text-h6"
      >{{ `${data.ratingAgeLimits}+` }}</span>
    </v-col>
    <v-col
      cols="12"
      class="pb-0"
...
import type { WatchApiExpandedItem, WatchApiGetFacts, WatchApiGetStaffByKpid } from '@/api/watch'
